...
const backendMenuAliasMap: Record<string, string> = {
  ...
  "shortcut-nav": "/content-center/shortcut-nav",
  "operation/shortcut-nav/index": "/content-center/shortcut-nav",
  ...
  "page-data": "/content-center/page-data",
  ...
  special: "/content-center/special",
