...
public enum ResultCode {
    ...
    AGENT_ROLE_ALREADY_EXISTS(20035, "代理商身份已存在"),
    AGENT_ROLE_NOT_FOUND(20036, "代理商身份不存在"),
    AGENT_BIND_ALREADY_EXISTS(20037, "代理商与店铺绑定关系已存在"),
    AGENT_BIND_NOT_FOUND(20038, "代理商与店铺绑定关系不存在"),
    AGENT_AUDIT_STATUS_ERROR(20039, "代理商审核状态错误"),
    AGENT_ROLE_REQUIRED(20040, "当前用户不是代理商"),
    STORE_BIZ_TYPE_ERROR(20041, "入驻业务类型错误"),
    AGENT_LEVEL_REQUIRED(20042, "代理商等级不能为空"),
    AGENT_LEVEL_ERROR(20043, "代理商等级错误"),
    AGENT_REGION_REQUIRED(20044, "代理商区域不能为空"),
    LOGIN_SESSION_INVALID(20045, "登录会话无效，请重新登录"),
    LOGIN_SESSION_EXPIRED(20046, "登录会话已过期，请重新登录"),
    IDENTITY_NOT_SUPPORTED(20047, "当前接口不支持所选身份"),
    IDENTITY_NOT_AVAILABLE(20048, "当前身份暂不可进入"),
    AGENT_AUDIT_PENDING(20049, "代理商资格审核中"),
    AGENT_AUDIT_REJECTED(20050, "代理商资格审核未通过"),
    STORE_AUDIT_PENDING(20051, "供货商资格审核中"),
    STORE_AUDIT_REJECTED(20052, "供货商资格审核未通过"),
    STORE_ACCOUNT_DISABLED(20053, "供货商账号已禁用"),
    STORE_ACCOUNT_NOT_FOUND(20054, "供货商账号不存在"),
    ONE_CLICK_LOGIN_ERROR(20055, "本机号码一键登录失败，请稍后重试"),
    ONE_CLICK_LOGIN_UNSUPPORTED(20056, "当前短信配置不支持本机号码一键登录"),
    /**
     * 权限
     */
    ...
    DISTRIBUTION_CASH_STATUS_ERROR(22008, "分销员提现记录状态错误"),
    ...
    STORE_AUDIT_STATUS_ERROR(50013, "店铺审核状态错误"),
