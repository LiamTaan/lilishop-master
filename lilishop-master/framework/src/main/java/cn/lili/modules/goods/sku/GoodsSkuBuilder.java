...
public class GoodsSkuBuilder {
    ...
    private static void builderSingle(GoodsSku goodsSku, Map<String, Object> skuInfo) {
        ...
        // 原始规格项
        String[] ignoreOriginKeys = {"id", "sn", "barcode", "cost", "price", "quantity", "weight", "alertQuantity"};
        //获取规格信息
        ...
        goodsSku.setBarcode(Convert.toStr(skuInfo.get("barcode"), goodsSku.getBarcode()));
