...
public class MemberEvaluationServiceImpl extends ServiceImpl<MemberEvaluationMapper, MemberEvaluation> implements MemberEvaluationService {
    ...
    public MemberEvaluationVO queryById(String id) {
        ...
        this.checkCurrentAgentStorePermission(memberEvaluation == null ? null : memberEvaluation.getStoreId());
        return new MemberEvaluationVO(memberEvaluation);
    }
    ...
    private void checkCurrentAgentStorePermission(String storeId) {
        ...
        if (currentUser == null || !agentRoleRelationService.isAgent(currentUser.getId())) {
            return;
        }
        if (storeId == null) {
