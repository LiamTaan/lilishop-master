...
public class VerificationServiceImpl implements VerificationService {
    ...
    public Boolean checkCreateVerification(String type, String filePath) {
        ...
        String normalizedType = VerificationSourceEnum.normalizeType(type);
        ...
        if (VerificationSourceEnum.isResourceType(normalizedType)) {
            originalResource = filePath;
        } else if (VerificationSourceEnum.isSliderType(normalizedType)) {
