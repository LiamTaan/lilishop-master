 ...
 */
@RestController
@RequestMapping("/manager/other/homeRecommendationStrategy")
public class HomeRecommendationStrategyManagerController {
    ...
    public ResultMessage<PlatformHomeConfigVO> save(@Valid @RequestBody PlatformHomeConfigSaveDTO saveDTO) {
        ...
        merged.setFrequentStoresConfig(saveDTO.getFrequentStoresConfig());
        merged.setGuessYouLikeConfig(saveDTO.getGuessYouLikeConfig());
        merged.setLowPriceZoneConfig(saveDTO.getLowPriceZoneConfig());
        merged.setTodaySpecialConfig(saveDTO.getTodaySpecialConfig());
