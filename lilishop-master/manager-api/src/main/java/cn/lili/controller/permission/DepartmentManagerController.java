...
public class DepartmentManagerController {
    ...
    @PostMapping
    public ResultMessage<Department> save(@Validated @RequestBody Department department) {
        departmentService.save(department);
        return ResultUtil.data(department);
    }

    @PutMapping("/{id}")
    public ResultMessage<Department> update(@PathVariable String id, @Validated @RequestBody Department department) {
